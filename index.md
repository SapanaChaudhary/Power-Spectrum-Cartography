...
* Performing algorithmically smarter localization.
* Taking the sector dynamics into account for localization. 
* Averaging power over traces corresponding to a particular user.
* Removing shadowing from the power values to get better estimates of the path loss component .
